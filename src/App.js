...
function App() {
  ...
  const genQR = () => {
    ...
    if (mytext !== "" && mysize !== "") {
      ...
      downloadButton.href = myimg.src; // Set the href of downloadButton to the generated QR code image source
      downloadButton.download = "qrcode.png"; // Set the download attribute to specify the filename
  ...
  const resetQR = () => {
    ...
    myimg.src = ""; // Clear the QR code image source
    qrtext.value = ""; // Clear the input text
    size.value = "250"; // Reset the size dropdown to the default value
  ...
  return (
    <div>
      ...
      <div className="lg:2/6 xl:w-2/4 mt-20 lg:mt-40 lg:ml-16 text-left">
        <div className="text-6xl font-semibold text-gray-900 leading-none">Go The Easy Way</div>
        <div className="mt-6 text-xl font-light text-true-gray-500 antialiased">Introducing "EmQR" - the go-to QR code creator website that makes generating QR codes a breeze. With the tagline "Go the Easy Way," EmQR offers a seamless and user-friendly platform to create customized QR codes effortlessly. Whether you're looking to create QR codes for websites, marketing materials, or personal use, EmQR has you covered. With its intuitive interface and wide range of customization options, you can easily design QR codes that align with your brand identity. EmQR streamlines the QR code creation process, saving you time and ensuring a hassle-free experience. Simplify your QR code needs with EmQR and go the easy way.</div>
      ...
      <div className="grid">
        <h2 align="center" className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Qr Code Generator</h2>
        <br /> <br />
        <select id="size" className="hs-dropdown relative inline-flex" style={{ border: '1px solid black' }}>
        ...
        <br /><br />
        <textarea placeholder="Enter Your Text" id="qrtext" style={{ border: '1px solid black' }}></textarea>
        <br /><br />
        <input type="submit" value="Generate" onClick={genQR} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" />
        <center>
          <img src="" id="img" alt='' />
          <a id="downloadButton"
            href="/"
            download="qrcode.png"
            style={{ display: "none" }}><button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" id='img'>Download Image</button>
          </a>
          <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onClick={resetQR}>RESET</button></center>

      </div>
      <br /> <br />
      <h1 align="Center" className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Get QR in 3 Easy Steps</h1> <br /> <br />
      <br /> <br />
      <div className="columns">
        <div className="column">
          <div className="max-w-sm rounded overflow-hidden shadow-lg"> <img className="w-full" src="https://i.ibb.co/Yp9zjvZ/image.png" alt="Sunset in the mountains" /> <div className="px-6 py-4"> <div className="font-bold text-xl mb-2">The Coldest Sunset</div> <p className="text-gray-700 text-base"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil. </p> </div> <div className="px-6 pt-4 pb-2"> <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#photography</span> <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#travel</span> <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#winter</span> </div> </div>
        </div>
        <div className="column">
          <div className="max-w-sm rounded overflow-hidden shadow-lg"> <img className="w-full" src="https://i.ibb.co/fvPQH4V/image.png" alt="Sunset in the mountains" /> <div className="px-6 py-4"> <div className="font-bold text-xl mb-2">The Coldest Sunset</div> <p className="text-gray-700 text-base"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil. </p> </div> <div className="px-6 pt-4 pb-2"> <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#photography</span> <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#travel</span> <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#winter</span> </div> </div>
        </div>
        <div className="column">
          <div className="max-w-sm rounded overflow-hidden shadow-lg"> <img className="w-full" src="https://i.ibb.co/M7GPfNK/image.png" alt="Sunset in the mountains" /> <div className="px-6 py-4"> <div className="font-bold text-xl mb-2">The Coldest Sunset</div> <p className="text-gray-700 text-base"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil. </p> </div> <div className="px-6 pt-4 pb-2"> <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#photography</span> <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#travel</span> <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#winter</span> </div> </div>
        </div>
      ...
      <h1 align="center" className="text-4xl font-bold tracking-tight text-black sm:text-6xl">Features Of Em-QR</h1>
      <section className="relative pt-16 bg-white-600">
        <div className="container mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-78">
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-indigo-500">
                ...
                <blockquote className="relative p-8 mb-4">
                  <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95" className="absolute left-0 w-full block h-95-px -top-94-px">
                    <polygon points="-30,95 583,95 583,65" className="text-indigo-600 fill-current"></polygon>
                  </svg>
          ...
          <div className="lg:flex items-stretch md:mt-12 mt-8">
            ...
            <div className="lg:w-1/2 xl:ml-8 lg:ml-4 lg:mt-0 md:mt-6 mt-4 lg:flex flex-col justify-between">
              <div className="relative">
                ...
                <img src="https://i.ibb.co/NN4y8th/img-4.png" className="w-full mt-8 md:mt-6 hidden sm:block" alt="kitchen setup" />
                <img className="w-full mt-4 sm:hidden" src="https://i.ibb.co/6XYbN7f/Rectangle-29.png" alt="kitchen setup" />
              </div>
              <div className="relative">
                <div>
                  <p className="md:p-10 p-6 text-xs font-medium leading-3 text-white absolute top-0 right-0">12 April 2021</p>
                ...
                <img src="https://i.ibb.co/wMw2X7W/img-5.png" className="w-full mt-8 md:mt-6 hidden sm:block" alt="living room" />
                <img className="w-full mt-4 sm:hidden" src="https://i.ibb.co/6XYbN7f/Rectangle-29.png" alt="living room" />
              </div>
            </div>
          </div>
        </div>
